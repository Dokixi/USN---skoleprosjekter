...
print("F&oslash;lgende personer er registrert: <br/>");    /* Printer ut en beskjed før det blir vist registrerte personer */
print("<br/>");
...
while($linje=fgets($fil))              /* En linje lest fra fil */
{
    if($linje!="")                     /* Linjen lest fra fil er ikke tom */
    {
        ...
        $klassekode=trim($del[0]);           /* klassekode hentes ut */
